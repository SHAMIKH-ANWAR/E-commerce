...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        " relative flex h-[350vh] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <div
          className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-yellow-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
