...
import { useProducts } from "@/components/contexts/ProductWatch";
...
const ProductCard = React.memo(({ product }) => (
  <BackgroundGradient className="rounded-[22px] max-w-lg p-4 sm:p-6 bg-white dark:bg-zinc-900">
    ...
    <div className="flex justify-evenly gap-4 md:gap-32">
      ...
      <div className="rounded-full pl-4 pr-1 py-1 text-white flex items-center space-x-1 mt-4 text-xs font-bold dark:bg-zinc-800">
